...
// Meta4
        ...
        fact: "meta4mvp/fact",
        ux: "meta4mvp/ux",
        ux_mixin: "meta4mvp/ux.mixin",
        ux_dialog: "meta4mvp/ux.dialog",
        iq: "meta4mvp/iq",
        asq: "meta4mvp/asq",
        meta4app: "meta4mvp/meta4app",
        splash: "meta4mvp/splash",
        mobility: "meta4mvp/mobility",
...
console.log("meta4mvp: %o ", options)
    splash.open({ url: "splash.html", waitForClick: true})

    // Load and start the meta4 code
    // handle global/fatal errors
    try {
        require(['meta4app'], function (meta4mvp) {
console.log("Starting meta4mvp: %o", options)
            try {
                meta4mvp.start( options )

                meta4mvp.on("ux:boot", function(ux, options) {
